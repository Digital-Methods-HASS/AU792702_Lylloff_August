...
date: '27 March updated `r format(Sys.time(), "%d %B, %Y")`'
By: "August P. Lylloff" 
...
Wait, so "anger" is showing up in NRC lexicon as "fear"? Let's check:
```{r nrc-confidence}
